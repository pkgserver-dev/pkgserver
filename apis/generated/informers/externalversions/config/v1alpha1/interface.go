...
type Interface interface {
	// PackageVariants returns a PackageVariantInformer.
	PackageVariants() PackageVariantInformer
...
// PackageVariants returns a PackageVariantInformer.
func (v *version) PackageVariants() PackageVariantInformer {
	return &packageVariantInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
