	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PkgV1alpha1().PackageRevisionResourceses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PkgV1alpha1().PackageRevisionResourceses(namespace).Watch(context.TODO(), options)
			},
		},
		&pkgv1alpha1.PackageRevisionResources{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *packageRevisionResourcesInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pkgv1alpha1.PackageRevisionResources{}, f.defaultInformer)
}
