...
import (
	...
	v1alpha1 "github.com/pkgserver-dev/pkgserver/apis/generated/listers/pkg/v1alpha1"
...
type PackageRevisionInformer interface {
	...
	Lister() v1alpha1.PackageRevisionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PkgV1alpha1().PackageRevisions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PkgV1alpha1().PackageRevisions(namespace).Watch(context.TODO(), options)
			},
		},
		&pkgv1alpha1.PackageRevision{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *packageRevisionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pkgv1alpha1.PackageRevision{}, f.defaultInformer)
}

func (f *packageRevisionInformer) Lister() v1alpha1.PackageRevisionLister {
	return v1alpha1.NewPackageRevisionLister(f.Informer().GetIndexer())
}
