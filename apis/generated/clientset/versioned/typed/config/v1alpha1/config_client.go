...
type ConfigV1alpha1Interface interface {
	...
	PackageVariantsGetter
	RepositoriesGetter
}

// ConfigV1alpha1Client is used to interact with features provided by the config.pkg.pkgserver.dev group.
type ConfigV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigV1alpha1Client) PackageVariants(namespace string) PackageVariantInterface {
	return newPackageVariants(c, namespace)
}

func (c *ConfigV1alpha1Client) Repositories(namespace string) RepositoryInterface {
