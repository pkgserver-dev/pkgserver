...
func newPackageRevisionResourceses(c *PkgV1alpha1Client, namespace string) *packageRevisionResourceses {
...
func (c *packageRevisionResourceses) UpdateStatus(ctx context.Context, packageRevisionResources *v1alpha1.PackageRevisionResources, opts v1.UpdateOptions) (result *v1alpha1.PackageRevisionResources, err error) {
	result = &v1alpha1.PackageRevisionResources{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packagerevisionresourceses").
